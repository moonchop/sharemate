...
const GroupFeed = () => {
    ...
    return (
        <div>
        {groupData.map(({building, room, hashtag, text, people}) => 
            (<div className="h-3/6 ">
                <div className="flex my-2 justify-between ">
                <div className="flex flex-col">
                    <p className="flex text-black mx-2">{`[${building} ${room}인실]`}</p>
