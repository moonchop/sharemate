...
import com.shareMate.shareMate.entity.WishListEntity;
...
@Repository
public interface WishListRepository extends JpaRepository<WishListEntity,Number> {


    List<WishListEntity> findAllByGroupID(int group_id);
